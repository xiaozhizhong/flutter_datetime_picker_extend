...
///@author xiao
///@date 2021/2/23
///@desc 修改自官方picker，仅包含以下修改：
///1.将_kHighlighterBorder修改为透明色，以隐藏border
///
...
class CupertinoPicker extends StatefulWidget {
  ...
  CupertinoPicker({
    ...
    bool looping = false,
        ...
        assert(squeeze > 0),
        childDelegate =
            looping ? ListWheelChildLoopingListDelegate(children: children) : ListWheelChildListDelegate(children: children),
        super(key: key);
